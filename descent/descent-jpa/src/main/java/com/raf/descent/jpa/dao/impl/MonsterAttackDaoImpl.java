...
import com.raf.descent.jpa.dao.MonsterAttackDao;
import com.raf.descent.jpa.domain.card.MonsterAttack;
import com.raf.descent.jpa.domain.card.MonsterStatDicePk;

/**
 * Implementation DAO for {@link MonsterAttack}.
 * 
 * @author RAF
 */
@Repository
public final class MonsterAttackDaoImpl extends AbstractDao<MonsterAttack, MonsterStatDicePk> implements
    MonsterAttackDao {

  /**
   * Constructor.
   */
  public MonsterAttackDaoImpl() {
    super(MonsterAttack.class);
  }
   ...
   * @param example
   *          the example
   * @see AbstractDao#getPredicates(Root, MonsterAttack)
   */
  @Override
  protected Predicate[] getPredicates(final Root<MonsterAttack> root, final MonsterAttack example) {
   ...
   *          the predicate list
   */
  private void addMonsterStatFilter(final Root<MonsterAttack> root, final MonsterAttack example,
   ...
   */
  @Override
  protected List<Order> getOrder(final CriteriaBuilder builder, final Root<MonsterAttack> root) {
