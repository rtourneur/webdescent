...
import com.raf.descent.jpa.dao.MonsterSurgeDao;
import com.raf.descent.jpa.domain.card.MonsterSurge;
import com.raf.descent.jpa.domain.card.MonsterSurgePk;

/**
 * Implementation DAO for {@link MonsterSurge}.
 * 
 * @author RAF
 */
@Repository
public final class MonsterSurgeDaoImpl extends AbstractDao<MonsterSurge, MonsterSurgePk> implements
    MonsterSurgeDao {

  /**
   * Constructor.
   */
  public MonsterSurgeDaoImpl() {
    super(MonsterSurge.class);
  }
   ...
   * @param example
   *          the example
   * @see AbstractDao#getPredicates(Root, MonsterSurge)
   */
  @Override
  protected Predicate[] getPredicates(final Root<MonsterSurge> root, final MonsterSurge example) {
   ...
   *          the predicate list
   */
  private void addMonsterStatFilter(final Root<MonsterSurge> root, final MonsterSurge example,
   ...
   */
  @Override
  protected List<Order> getOrder(final CriteriaBuilder builder, final Root<MonsterSurge> root) {
